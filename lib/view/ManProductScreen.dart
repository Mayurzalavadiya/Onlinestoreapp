...
class ManProductScreen extends StatefulWidget {
  @override
  ManProductScreenState createState() => ManProductScreenState();
}

class ManProductScreenState extends State<ManProductScreen>
    ...
    return Scaffold(
        ...
        title: Stack(
          ...
          bottom: new TabBar(
            ...
            tabs: const <Tab>[
              const Tab(text: 'Sweater',),
              const Tab(text: 'Jacket'),
              const Tab(text: 'Socks'),
