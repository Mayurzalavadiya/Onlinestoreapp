...
class Right_navigationDrawer extends StatelessWidget {
    ...
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
              title: Text(string.categories, style: TextStyle(fontSize: 16, color:  getColorFromHex(ColorCode.Color_blue)),),
              onTap: () {
